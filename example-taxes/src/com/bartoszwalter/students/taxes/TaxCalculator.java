...
import com.bartoszwalter.students.taxes.StopyPodatkowe.KluczSkladki;
import com.bartoszwalter.students.taxes.StopyPodatkowe.StopyOpodatkowania2017;
...
public class TaxCalculator {
    ...
    public static void main(String[] args) {
        ...
        if (umowa == 'P') {
            ...
            StopyPodatkowe stopyPodatkowe = new StopyPodatkowe(StopyOpodatkowania2017.STOPA_UBEZPIECZENIA_EMERYTALNEGO, StopyOpodatkowania2017.STOPA_UBEZPIECZENIA_RENTOWE, StopyOpodatkowania2017.STOPA_UBEZPIECZENIA_CHOROBOWE, StopyOpodatkowania2017.STOPA_UBEZPIECZENIA_ZDROWOTNEGO);
            ...
            System.out.println("Podstawa wymiaru składek " + umowaOPrace.pobierzPostawe());
            double oPodstawa = obliczonaPodstawa(podstawa); //stary kod, ale nie już się robi
            System.out.println("Składka na ubezpieczenie emerytalne "
                    + df00.format(zestawSkladek.get(KluczSkladki.SKLADKA_EMERYTALNA)));
            System.out.println("Składka na ubezpieczenie rentowe    "
                    + df00.format(zestawSkladek.get(KluczSkladki.SKLADKA_RENTOWA)));
            System.out.println("Składka na ubezpieczenie chorobowe  "
                    + df00.format(zestawSkladek.get(KluczSkladki.SKLADKA_CHOROBOWA)));
            System.out
